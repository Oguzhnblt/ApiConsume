...
namespace WebApi.Jwt.Models
{
    public class CreateToken
    {
        ...
        public string TokenCreateAdmin()
        {
            ...
            JwtSecurityToken tokenAdmin = new JwtSecurityToken(issuer: "http://localhost", audience: "http://localhost", notBefore: DateTime.Now, expires: DateTime.Now.AddSeconds(20), signingCredentials: credentials);

            JwtSecurityTokenHandler handler = new JwtSecurityTokenHandler();
            return handler.WriteToken(tokenAdmin);
        }
    }
}
